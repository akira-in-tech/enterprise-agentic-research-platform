...
class PlannerAgent:
    ...
    async def create_plan(self, query: str) -> ResearchPlan:
        ...
        prompt = (
            "Create a focused research plan for the following request. The "
            "request may come from any domain: engineering, cloud "
            ...
            "- Choose outline sections that fit the request's actual domain "
            "rather than defaulting to a fixed template. For example, an "
            "engineering request may need technical background, "
            "architecture, trade-offs, reliability, performance, and "
            "security sections; a market or vendor request may need market "
            "definition, competitive landscape, customer segments, and "
            "risks; a policy or regulatory request may need current rules, "
            "jurisdictional differences, and compliance implications. Every "
            "outline still ends with a recommendations-style section and a "
            "references section.\n"
